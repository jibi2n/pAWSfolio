  ...
  return (
    <div className="modal-backdrop fixed inset-0 z-[100] flex items-center justify-center p-6" onClick={onCancel}>
      <div
        ...
        className="w-full max-w-sm p-8 flex flex-col gap-5 bg-white rounded-card shadow-[0_24px_64px_rgba(46,26,95,0.25)]"
        onClick={e => e.stopPropagation()}
      >
        <div className="w-12 h-12 rounded-btn flex items-center justify-center bg-[#FEF2F2]">
        ...
        <div>
          ...
          <p className="text-[14px] text-[#64748B] leading-relaxed">Delete this build and its comments? This can&apos;t be undone.</p>
        </div>
